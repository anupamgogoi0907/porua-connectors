...
public class PoruaDatabaseConnectorDefinitionParser extends PoruaBeanDefinitionParser {
  ...
  protected void doParse(Element element, BeanDefinitionBuilder builder) {
    builder.setScope(BeanDefinition.SCOPE_PROTOTYPE);String query= element.getAttribute("query");builder.addPropertyValue("query",query);String configRef=element.getAttribute("config-ref");RuntimeBeanReference configRefBean = new RuntimeBeanReference(configRef);builder.addPropertyValue("config",configRefBean);}
}
