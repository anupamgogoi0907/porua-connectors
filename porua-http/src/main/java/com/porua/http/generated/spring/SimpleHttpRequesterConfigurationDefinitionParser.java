...
public class SimpleHttpRequesterConfigurationDefinitionParser extends PoruaBeanDefinitionParser {
  ...
  protected void doParse(Element element, BeanDefinitionBuilder builder) {
    builder.setScope(BeanDefinition.SCOPE_PROTOTYPE);String name= element.getAttribute("name");builder.addPropertyValue("name",name);String method= element.getAttribute("method");builder.addPropertyValue("method",method);String host= element.getAttribute("host");builder.addPropertyValue("host",host);String port= element.getAttribute("port");builder.addPropertyValue("port",port);String path= element.getAttribute("path");builder.addPropertyValue("path",path);String parmsfile= element.getAttribute("parmsfile");builder.addPropertyValue("parmsfile",parmsfile);String headersfile= element.getAttribute("headersfile");builder.addPropertyValue("headersfile",headersfile);}
}
